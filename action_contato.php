...
<head>
    ...
    <title>Imagem Refresh - Resultado do Formulário</title>
    ...
    <main>
        ...
        <div class="contato-form">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                echo "<p><strong>Assunto:</strong> " . htmlspecialchars($_POST["assunto"]) . "</p>";
                ...
                foreach ($_POST as $campo => $valor) {
                    if (!in_array($campo, ["nome", "email","assunto", "mensagem"])) {
